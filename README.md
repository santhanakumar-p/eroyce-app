# E Royce Service Manager Live Tracking App

## UI/UX Wireframe Presentation (Design Deliverable)

This repository contains a **high-fidelity interactive wireframe deck** for client presentation.

**Scope:** UI/UX design only — no Flutter, React Native, Laravel, or backend code.
